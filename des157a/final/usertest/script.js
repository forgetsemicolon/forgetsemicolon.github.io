(function() {
    ...
    function displayInfo() {
        ...
        const myText = "Hello! Welcome to my game! Here are the tasks: ";

        inst.innerHTML = myText;

        inst.innerHTML += "<br><li>Play the game</li><li>Turn the sound on/off</li><li>Check instructions in the middle of the game</li>"

        inst.innerHTML += "<br>RULES: There are two players. The player whose turn it is rolls the dice. The total of the roll is added to the current player's score, unless either die comes up as a 'one'. If this happens, this player's turn is over, and it is the other player’s turn. After each roll, the current player can either roll again, (assuming a 'one' was not rolled) or if the current player feels that luck is running thin, they can pass to the other player.";
